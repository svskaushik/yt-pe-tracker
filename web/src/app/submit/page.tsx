...
export const metadata = {
  ...
  description: 'Submit a new YouTube channel acquisition or investment for review and inclusion in our database.',
};

export default function SubmitPage() {
  // Pre-filled GitHub issue URL
  const githubIssueUrl = 'https://github.com/your-username/yt-pe-tracker/issues/new?template=channel-submission.md&title=%5BSubmission%5D%20New%20Channel%20Acquisition';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card rounded-lg border border-border p-6 mb-8">
            ...
            <div className="space-y-3 text-muted-foreground">
              <p>
                <strong>What we track:</strong> Private equity acquisitions, investments, partnerships, and management deals involving YouTube channels.
              </p>
              <p>
                <strong>Required information:</strong> Channel name, PE firm, acquisition type, date, and credible source (news article, press release, etc.).
              </p>
              <p>
                <strong>Quality standards:</strong> All submissions are reviewed for accuracy. Please provide multiple sources when available.
              </p>
            </div>
          </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-br from-primary/10 to-accent/10 rounded-lg p-8 border border-border">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Click the button below to open a pre-filled GitHub issue. This helps us track submissions and maintain data quality through our review process.
              </p>
          ...
          <div className="mt-12 bg-card rounded-lg border border-border p-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-foreground mb-2">Data Contributors</h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Most submissions are reviewed within 7-14 days, depending on the complexity and source verification required.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Submit what you have! We can work together to fill in missing details or find additional sources.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Absolutely! Use the same submission process and specify that you're correcting existing data.
                </p>
              </div>
            </div>
          </div>
